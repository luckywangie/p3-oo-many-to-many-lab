...
def test_contract_contracts_by_date():
    ...
    Contract.all_contracts = []  # Resetting the contract list
    ...
    # Check if contracts are sorted by date for '01/01/2001'
    result = Contract.contracts_by_date('01/01/2001')

    # Assert that contracts are sorted correctly
    assert result == [contract2, contract4]
